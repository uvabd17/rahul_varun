package com.linkedinlite.connection.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> invalid(InvalidRequestException ex) {
    ...
    private ResponseEntity<ErrorResponse> build(HttpStatus s, String code, String msg,
        ...
        return ResponseEntity.status(s).body(
                ErrorResponse.builder().success(false).code(code).message(msg)
